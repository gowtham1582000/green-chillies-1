	...
	$.Shop.prototype = {
		...
		sendmail:function(){
			...
			for (var i = 0; i < items.length; i++) {
			  ...
			  price2.push(price1);
			  quantity1.push(quantity);
			
			}
			if(mail!="" && phone!="" && address!=""&&name!="" && cartTotal!=0){
				if(mail.match(mailformat)){

			emailjs.send("service_l5n2nfh", "template_pjnd6n8", {
				name: name,
				email: mail,
				address: address,
				number: phone,
				...
				alert("Your Order has been Placed. Please Wait for our team to reach you")
				window.location.href='menu.html';


			}
			else{
				alert("please check the Mail Format")
			}
		}else{
